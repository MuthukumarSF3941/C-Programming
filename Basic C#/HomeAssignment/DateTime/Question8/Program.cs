...
class Program
{
    public static void Main(string[] args)
    {
        ...
        if(temp==-1)
        {
                System.Console.WriteLine($"{date1.ToString("dd/MM/yyyy")} is earlier than {date2.ToString("dd/MM/yyyy HH:mm:ss tt")}");
        }
        else if(temp==0)
        {
        ...
        {
                System.Console.WriteLine($"{date1.ToString("dd/MM/yyyy")} is later than {date2.ToString("dd/MM/yyyy")}");
        }
    }
}
